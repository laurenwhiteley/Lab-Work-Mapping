...
for file in os.listdir("."):
    if fnmatch.fnmatch(file, "featurecounts_PA*.txt"):
...
bowtieFiles = []
for file in os.listdir("."): 
    if fnmatch.fnmatch(file, "PA*.bowtie_output.txt"):
...
meanCoverageList = []
with open("PA_meanCoverage.txt", "r") as a_file:
    for line in a_file:
...
percentCoverageList = []
with open("PA_percentCoverage.txt", "r") as a_file:
    for line in a_file:
